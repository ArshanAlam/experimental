...
class IndexView(generic.ListView):
    ...
    def get_queryset(self):
        ...
        that are set to be published in the future).
        """
...
def vote(request, question_id):
    ...
    try:
        ...
        # Returning HttpResponseRedirect after processing POST data to prevent
        # the client from posting (for instance using the back button)
